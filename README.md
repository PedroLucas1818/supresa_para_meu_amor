...
<head>
    ...
    <!-- Google Fonts: Charm for 'Eu te amo' and Forum for other text -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Charm:wght@400;700&family=Forum&display=swap" rel="stylesheet">
    <style>
        body {
            /* Fundo com gradiente suave para um toque romântico */
            background: linear-gradient(135deg, #fce4ec, #e0f2f7);
            font-family: 'Forum', serif; /* Fonte principal do site: Forum */
            overflow: hidden; /* Evita barras de rolagem */
        }

        /* Estilo para o botão principal */
        .animated-button {
            transition: all 0.5s ease-in-out; /* Transição suave para o movimento */
            position: absolute;
            /* Removendo top/left/transform iniciais para que o JS defina */
            z-index: 10; /* Garante que o botão fique acima de outros elementos */
            white-space: normal;
            line-height: 1.2;
        }

        /* Estilos para a tela final (Eu te amo) */
        .final-screen {
            background: linear-gradient(135deg, #ffe0f0, #e0f0ff); /* Gradiente mais claro para a tela final */
            display: flex;
            ...
            transition: opacity 1s ease-in-out; /* Transição suave para aparecer */
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
            pointer-events: none; /* Não permite cliques enquanto invisível */
            z-index: 20; /* Fica por cima da tela inicial */
        }
